    ...
    public partial class ProjectionExplorerForm : Form
    {
        ...
        private void btnLoadShapeFile_Click(object sender, EventArgs e)
        {
            ...
            if (fileDialog.ShowDialog() == DialogResult.OK)
            {
                ...
                featureSet1 = (FeatureSet)FeatureSet.Open(fileDialog.FileName);
        ...
        private void btnRegionArea_Click(object sender, EventArgs e)
        {
            ...
            setVisible(lblMap1SelectedArea, true);
            setVisible(lblmap2selectedinfo, true);
            setVisible(lblMap2SelectedArea, true);
            setVisible(lblmap3selectedinfo, true);
            setVisible(lblMap3SelectedArea, true);
            setVisible(lblmap4selectedinfo, true);
            setVisible(lblMap4SelectedArea, true);
            setVisible(lblmap5selectedinfo, true);
            setVisible(lblMap5SelectedArea, true);
            setVisible(lblmap6selectedinfo, true);
            setVisible(lblMap6SelectedArea, true);
